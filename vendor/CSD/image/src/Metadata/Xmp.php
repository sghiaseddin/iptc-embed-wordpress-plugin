...
class Xmp
{
     ...
     *
     */
    const PLUS_NS = 'http://ns.useplus.org/ldf/xmp/1.0/';
     ...
     * {@inheritdoc}
     *
     * todo: rename to getLicensor
     */
    public function getLicensor()
    {
        $seq = $this->getSeq('plus:Licensor', self::PLUS_NS);
    ...
    /**
     * @param $Licensor string
     *
     * @return $this
     */
    public function setLicensor($Licensor)
    {
        return $this->setSeq('plus:Licensor', $Licensor, self::PLUS_NS);
    }
    
    /**
     * @return string
     */
    public function getLicensorURL()
    {
        $seq = $this->getSeq('plus:LicensorURL', self::PLUS_NS);
    ...
    /**
     * @param $licensorurl string
     *
     * @return $this
     */
    public function setLicensorURL($licensorurl)
    {
        return $this->setSeq('plus:LicensorURL', $licensorurl, self::PLUS_NS);
    }
